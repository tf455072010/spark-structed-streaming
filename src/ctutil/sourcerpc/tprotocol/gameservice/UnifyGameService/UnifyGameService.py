...
from ctutil.sourcerpc.tprotocol.gameservice import UnifyGameModel
...
class allGames_result(object):
    ...
    thrift_spec = (
        (0, TType.LIST, 'success', (TType.STRUCT, (UnifyGameModel.ttypes.UnifyGameInfoProtoc, UnifyGameModel.ttypes.UnifyGameInfoProtoc.thrift_spec), False), None, ),  # 0
    )
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i4 in range(_size0):
                        _elem5 = UnifyGameModel.ttypes.UnifyGameInfoProtoc()
                        _elem5.read(iprot)
